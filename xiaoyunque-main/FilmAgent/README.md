...
> [!NOTE]
> This repository also keeps **XiaoYunQue**, but **FilmAgent is an independent legacy research project** from the lab. It is preserved here for archival and reproducibility purposes only. FilmAgent does not depend on XiaoYunQue, and XiaoYunQue does not call FilmAgent.
>
